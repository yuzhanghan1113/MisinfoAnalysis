...
def main(argv):
    ...
    opts, args = getopt.getopt(argv, '', ["absFilename_input_rootTweets=", "path_input_rootTweetReplies=", "absFilenamePattern_output_timeSeries=", "index_inputDF_start=", "index_inputDF_end=", "absFilenamePattern_log="])
    ...
    for opt, arg in opts:
        ...
        elif opt == '--path_input_rootTweetReplies':
