...
list_items = c(
  ...
  "ROOTTWEETS_communicativeIntention_REP"
)
NUM_FACTORS = 2
measurePrefix = "measureIndependent_test_"
...
# list_items = c(list_items, "CASCADEEND_RETWEETS_retweet_median_user_statusesCount")
...
# EFAresult1 = factanal(~ ., data=df_input_toAnalyze_standardized, factors = NUM_FACTORS, rotation = "varimax", na.action = na.exclude, lower = 0.01, scores = c("Bartlett"))
EFAresult1
# EFAresult1$scores
