...
def main(argv):
    ...
    list_timeScopes = ["7days-combined"]

    
    #list_staMethods = ["NONE", "producerEngagement", "producerFollowers"]
    #list_staMethods = ["producerFollowers"]
    list_staMethods = ["NONE", "producerFollowers"]
                ...
                for str_timeScope in list_timeScopes:
                    ...
                    for str_staMethod in list_staMethods:
                        ...
                        for str_rootTweetLabel, str_columnToVisualize in list_rootTweetLabelAndColumnsToVisualize:
                            ...
                            sns_plot = sns.lineplot(x="cascadeAge_min", y=str_columnToVisualize, data=df_input_toVisualize, ax=axes, label=str_rootTweetLabel, legend=False)                 
