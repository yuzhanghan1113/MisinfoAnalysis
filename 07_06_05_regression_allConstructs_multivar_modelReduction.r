...
regression = function(feature_y, vector_featureX_main_singleTerms, vector_featureX_main_interTerms, vector_featureX_control, df_input_toAnalyze) {
  
  vector_featureX = c(vector_featureX_main_singleTerms, vector_featureX_control)
  ...
  if (mainXInteraction == "T") {
    for (interTerm in vector_featureX_main_interTerms) {
      
      if (num_indVarInFormula >= 1) {
        str_formula = paste(str_formula,
                            " + ",
                            sep = "")
      }
...
if (modelingTask=="full" |
  ...
  for (veracity in vector_veracities) {
    ...
    for (index_task in 1:9) {
      ...
      vector_featureX_main_singleTerms = c()
      vector_featureX_main_interTerms = c()
      vector_featureX_control = c()
      
      if (index_task == 1) {
        vector_featureX_main_singleTerms = c(vector_producerFeatures_user, vector_producerFeatures_userDescription)
        vector_featureX_control = c()
        vector_featureX = c(vector_featureX_main_singleTerms, vector_featureX_control)
        str_name_X = "producer"
        ...
        vector_featureX_main_singleTerms = c(vector_rootTweetFeatures_fullText)
        ...
        vector_featureX_main_singleTerms = c(vector_rootTweetFeatures_meta, vector_rootTweetFeatures_fullText)
        vector_featureX_control = c(vector_producerFeatures_user, vector_producerFeatures_userDescription)
        vector_featureX = c(vector_featureX_main_singleTerms, vector_featureX_control)
        ...
        vector_featureX_main_singleTerms = c(vector_producerIntention)
        vector_featureX_control = c(vector_producerFeatures_user, vector_producerFeatures_userDescription)
        vector_featureX = c(vector_featureX_main_singleTerms, vector_featureX_control)
      ...
      if (index_task %in% c(1, 2, 3, 4, 5)) {
        ...
        for (index_feature1 in 1:(length(vector_producerIntention)-1)) {
          for (index_feature2  in (index_feature1+1):length(vector_producerIntention)) {
            vector_featureX_main_interTerms = c(vector_featureX_main_interTerms, paste(vector_producerIntention[index_feature1], ":", vector_producerIntention[index_feature2], sep=""))
          }
        }
        # print(length(vector_featureX_main_interTerms))
      }
      
      vector_featureX_main_singleTerms_org = vector_featureX_main_singleTerms
      vector_featureX_main_interTerms_org = vector_featureX_main_interTerms
      vector_featureX_control_org = vector_featureX_control
      ...
      for (feature_y in vector_featureY) {
        ...
        #                                 )]
        df_input_toAnalyze = df_input[df_input$ROOTTWEETS_veracityLabel_agg_misinformation == misinfo, ]
        ...
        tryCatch({
          ...
          vector_featureX_main_singleTerms = vector_featureX_main_singleTerms_org
          vector_featureX_main_interTerms = vector_featureX_main_interTerms_org
          vector_featureX_control = vector_featureX_control_org
          
          list_results = list("df_modelingResults"=data.frame(), "RSquared"=NA, "num_indVarInFormula"=NA)
          
          while(TRUE) {
            
            list_results_old = list_results
            
            list_results = regression(feature_y, vector_featureX_main_singleTerms, vector_featureX_main_interTerms, vector_featureX_control, df_input_toAnalyze)
            df_modelingResults = list_results[["df_modelingResults"]]
            
            # readline(prompt="1 Press [enter] to continue")
            
            list_varVectors = list("vector_featureX_main_singleTerms"=vector_featureX_main_singleTerms, "vector_featureX_main_interTerms"=vector_featureX_main_interTerms, "vector_featureX_control"=vector_featureX_control)
            list_names = list("vector_featureX_main_singleTerms", "vector_featureX_main_interTerms", "vector_featureX_control")
            
            vector_featureX_main_singleTerms_res = c()
            vector_featureX_main_interTerms_res = c()
            vector_featureX_control_res = c()
            
            for(name in list_names) {
  
              vector_vars_reduced = c()
  
              for(var in list_varVectors[[name]]) {
                if (var %in% rownames(df_modelingResults)) {
  
                  regression_coef = df_modelingResults[var, "Estimate"]
                  regression_p = df_modelingResults[var, "Pr(>|t|)"]
  
                  if (!is.nan(regression_p) & regression_p < 0.05 & !is.nan(regression_coef) & abs(regression_coef) >= THRESHOLD_COEF) {
                    vector_vars_reduced = c(vector_vars_reduced, var)
                  }
                }
              }
  
              if (name=="vector_featureX_main_singleTerms") {
                vector_featureX_main_singleTerms_res = vector_vars_reduced
              } else if (name=="vector_featureX_main_interTerms") {
                vector_featureX_main_interTerms_res = vector_vars_reduced
              } else if (name=="vector_featureX_control") {
                vector_featureX_control_res = vector_vars_reduced
              }
            }
  
            # vector_featureX_main_singleTerms = list_varVectors_results[["vector_featureX_main_singleTerms"]]
            # vector_featureX_main_interTerms = list_varVectors_results[["vector_featureX_main_interTerms"]]
            # vector_featureX_control = list_varVectors_results[["vector_featureX_control"]]
            
            print("vector_featureX_main_singleTerms:")
            print(vector_featureX_main_singleTerms)
            print("vector_featureX_main_singleTerms_res:")
            print(vector_featureX_main_singleTerms_res)
            print("vector_featureX_main_interTerms:")
            print(vector_featureX_main_interTerms)
            print("vector_featureX_main_interTerms_res:")
            print(vector_featureX_main_interTerms_res)
            print("vector_featureX_control:")
            print(vector_featureX_control)
            print("vector_featureX_control_res:")
            print(vector_featureX_control_res)
            ...
            if (
              (identical(vector_featureX_main_singleTerms, vector_featureX_main_singleTerms_res) & identical(vector_featureX_main_interTerms, vector_featureX_main_interTerms_res) & identical(vector_featureX_control, vector_featureX_control_res)) |
              (length(vector_featureX_main_singleTerms_res)<=0 & length(vector_featureX_main_interTerms_res)<=0 & length(vector_featureX_control_res)<=0)
                ) {
              
              print("Found final reduced model. Break.")
              
              break
            }
            
            
            # if (length(vector_featureX_main_singleTerms_res)<=0) {
            #   vector_featureX_main_singleTerms = vector_featureX_main_singleTerms
            # } else {
            #   vector_featureX_main_singleTerms = vector_featureX_main_singleTerms_res
            # }
            # 
            # if (length(vector_featureX_main_interTerms_res)<=0) {
            #   vector_featureX_main_interTerms = vector_featureX_main_interTerms
            # } else {
            #   vector_featureX_main_interTerms = vector_featureX_main_interTerms_res
            # }
            # 
            # if (length(vector_featureX_control_res)<=0) {
            #   vector_featureX_control = vector_featureX_control
            # } else {
            #   vector_featureX_control = vector_featureX_control_res
            # }
          ...
          df_modelingResults = list_results_old[["df_modelingResults"]]
          ...
          if (length(df_modelingResults) <= 0){
            next
          }
          
          vector_featureX_org = c(vector_featureX_main_singleTerms_org, vector_featureX_control_org)
          
          vector_featureX_selected = c()
          
          for (feature_x in vector_featureX_org) {
            if (feature_x %in% rownames(df_modelingResults)) {
              vector_featureX_selected = c(vector_featureX_selected, feature_x)
            }
          }
          
          num_observations = nrow(df_input_toAnalyze[, c(vector_featureX_selected, feature_y)]) - sum(apply(df_input_toAnalyze[, c(vector_featureX_selected, feature_y)], 1, anyNA))
          df_output[index_row, "num_observations"] = num_observations
            
          RSquared = list_results_old[["RSquared"]]
          num_indVarInFormula = list_results_old[["num_indVarInFormula"]]
          ...
          for (feature_x in vector_featureX_org) {
            ...
            if (feature_x %in% rownames(df_modelingResults)) {
              ...
              if (!is.nan(regression_p) & regression_p < 0.05 & !is.nan(regression_coef) & abs(regression_coef) >= THRESHOLD_COEF) {
                ...
                if (feature_x %in% vector_featureX_main_singleTerms_org) {
                  num_sigMainVar_singleTerm = num_sigMainVar_singleTerm + 1
                } else if (feature_x %in% vector_featureX_control_org) {
          ...
          if (mainXInteraction == "T") {
            for (str_term in vector_featureX_main_interTerms_org) {
      ...
      for(col in c(vector_columns_meta, vector_featureX_main_singleTerms_org, vector_featureX_main_interTerms_org, vector_featureX_control_org)) {
