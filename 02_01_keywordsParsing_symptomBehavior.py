...
def main(argv):
    ...
    opts, args = getopt.getopt(argv, '', ["path_input=", "path_output="])
    ...
    for absFilename_input in list_inputFileNames:
        ...
        absFilename_output = path_output + os.path.sep + absFilename_input.split(os.path.sep)[-1]
        absFilename_output = absFilename_output.replace('preprocessed_', 'keywordsDetected_')
