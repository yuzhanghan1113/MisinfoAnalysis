...
dir.create(file.path(path_output, "fullMdl"))
dir.create(file.path(paste(path_output, "fullMdl", sep=""), "cpl"))
dir.create(file.path(path_output, "reducedMdl"))
dir.create(file.path(paste(path_output, "reducedMdl", sep=""), "prt"))
